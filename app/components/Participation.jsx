...
function Participation() {
  ...
  return (
    <div className="relative px-8 w-full max-w-6xl h-[1000px] mx-auto bg-black max-[1220px]:w-[90%]">
      {/* Heading */}
      <motion.h2 
        className="absolute w-full text-center top-6 left-1/2 transform -translate-x-1/2 text-4xl font-bold text-white"
      ...
      <div className="absolute top-24 right-0 w-[52.5%] h-[49%]">
        ...
        <motion.div 
          className="absolute inset-6 rounded-lg p-4 flex flex-col justify-start"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
      ...
      <div className="absolute bottom-0 left-0 w-[55.5%] h-[49%]">
        ...
        >
          <motion.h3 
            className="text-[45px] text-center font-semibold text-white max-[1038px]:text-[40px] max-[896px]:text-[38px] max-[858px]:text-[35px] max-[802px]:text-[32px] max-[713px]:text-[29px] max-[602px]:text-[27px]"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.5, delay: 0.3 }}
          ...
          <motion.p 
            className="mt-4 text-[18px] text-white leading-relaxed text-justify max-[896px]:mt-2 max-[858px]:text-[17px] max-[714px]:text-[16px] max-[657px]:text-[15px] max-[637px]:mt-0"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.5, delay: 0.4 }}
