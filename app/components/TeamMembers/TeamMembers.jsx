      ...
      <div className="relative mx-auto max-w-8xl max-[420px]:max-w-[95vw]">
        ...
        <div className="mb-10">
          ...
          <div className="overflow-hidden transition-all duration-700 ease-in-out">
            <div className={`w-full px-10 grid grid-cols-2 overflow-hidden gap-10 max-[650px]:gap-5 max-[420px]:gap-4 max-[650px]:px-0 min-[1300px]:grid-cols-3 lg:grid-cols-4 ${showFull1 ? "max-h-[4500px] pb-10" : "max-h-[110vh] max-[600px]:max-h-[105vh] max-[415px]:max-h-[68vh]"} transition-all duration-700 ease-in-out`}>
        ...
        <div className="mb-10">
          ...
          <div className="mb-10 mx-auto w-70 h-0.5 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 transition-all duration-700 max-[500px]:w-50" />
          <div className="overflow-hidden transition-all duration-700 ease-in-out">
            <div className={`w-full px-10 grid grid-cols-2 overflow-hidden gap-10 max-[650px]:gap-5 max-[420px]:gap-4 max-[650px]:px-0 sm:grid-cols-2 lg:grid-cols-4 ${showFull3 ? "max-h-[4500px] pb-10" : "max-h-[110vh] max-[600px]:max-h-[105vh] max-[415px]:max-h-[68vh]"} transition-all duration-700 ease-in-out`}>
        ...
        <div className="mb-10">
          ...
          <div className="overflow-hidden transition-all duration-700 ease-in-out">
            <div className={`w-full px-10 grid grid-cols-2 overflow-hidden gap-10 max-[650px]:gap-5 max-[420px]:gap-4 max-[650px]:px-0 sm:grid-cols-2 lg:grid-cols-4 ${showFull2 ? "max-h-[3000px] pb-10" : "max-h-[110vh] max-[600px]:max-h-[105vh] max-[415px]:max-h-[68vh]"} transition-all duration-700 ease-in-out`}>
