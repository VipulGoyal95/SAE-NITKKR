...
import { alumni,Details3yr,Details4yr, Details2yr } from '../../data/members';
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 max-[420px]:px-3 py-20 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-8xl max-[420px]:max-w-[95vw]">
        ...
        <div className="mb-10">
          ...
          <div className="mb-10 mx-auto w-70 h-0.5 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 transition-all duration-700 max-[500px]:w-50" />
          <div className="overflow-hidden transition-all duration-700 ease-in-out">
            <div className={`w-full px-10 grid max-[800px]:grid-cols-2 overflow-hidden gap-10 max-[650px]:gap-5 max-[420px]:gap-4 max-[650px]:px-0 max-[1300px]:grid-cols-3 min-[1300px]:grid-cols-4 ${showFull4 ? "max-h-[5050px] pb-10" : "max-h-[760px] max-[650px]:max-h-[735px] max-[1300px]:max-h-[780px] max-[415px]:max-h-[550px] max-[420px]:max-h-[630px] max-[500px]:max-h-[636px]"} transition-all duration-700 ease-in-out`}>
              {Details2yr.map((member, index) => (
                <div 
                  key={member.id}
                  className="transform transition-all duration-1000"
                  style={{ 
          ...
          {!showFull4 && (
            <IoIosArrowDown className="mx-auto text-900 text-[35px] text-gray-400 cursor-pointer animate-bounce transform transition-all duration-300 hover:scale-110" onClick={() => setShowFull4(true)} />
          )}
          {showFull4 && (
            <IoIosArrowUp className="mx-auto text-900 text-[35px] text-gray-400 cursor-pointer animate-bounce transform transition-all duration-300 hover:scale-110" onClick={() => setShowFull4(false)} />
          )}
        </div>
