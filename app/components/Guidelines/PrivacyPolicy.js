function PrivacyPolicy() {
    return (
        <div className="w-[65%] mx-auto mt-[20vh] leading-8">
            ...
            <br /><br />
            <h2 className="text-3xl font-bold">Log Files</h2>
            <br />
            ...
            <h2 className="text-3xl font-bold">Advertising Partners Privacy Policies</h2>
            <br />
            ...
            <br /><br />
            <h2 className="text-3xl font-bold">Third Party Privacy Policies</h2>
            <br />
            ...
            <h2 className="text-3xl font-bold">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            <br />
            ...
            <br /><br />
            <h2 className="text-3xl font-bold">GDPR Data Protection Rights</h2>
            <br />
            ...
            <p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>
            <br /><br />
            <h2 className="text-3xl font-bold">Children's Information</h2>
            <br />
            <p>Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.</p>

            <p>SAE NIT Kurukshetra does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
        </div>
    );
}
