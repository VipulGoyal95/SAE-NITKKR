  ...
  return (
    <section className="bg-white py-16 px-8 min-[1050px]:px-14 max-[48rem]:px-6 overflow-hidden">
      ...
      <div className="flex flex-col gap-20">
        {/* ACCELERON */}
        <div ref={acceleronRef} className="flex flex-col md:flex-row items-center gap-12 max-[1050px]:gap-8">
          ...
          <motion.div 
            ...
            animate={isAcceleronVisible ? { opacity: 1, x: 0 } : { opacity: 0, x: 100 }}
          ...
          >
            ...
            <motion.p 
              ...
              animate={isAcceleronVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
        ...
        <div ref={nitroxRef} className="flex flex-col md:flex-row-reverse items-center gap-12 max-[1050px]:gap-8">
          <div className="relative w-full md:w-[500px] h-[350px] md:h-[500px] rounded-[35px] overflow-hidden mx-5 max-[768px]:w-[80%] max-[541px]:w-[90%]">
            <Image
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, x: -100 }}
            animate={isNitroxVisible ? { opacity: 1, x: 0 } : { opacity: 0, x: -100 }}
            transition={{ duration: 0.8, delay: 0.4 }}
          >
            ...
            <motion.p 
              ...
              initial={{ opacity: 0, y: 30 }}
              animate={isNitroxVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
